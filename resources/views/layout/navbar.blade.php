    ...
    <div class="container">
        <div class="flex -mx-4 items-center justify-between relative">
            <div class="pr-4 w-60 max-w-full">
                <a href="/" class="w-full flex items-center py-2 space-x-6">
                    <img src="{{ url('/img/personal-logo.svg') }}" alt="logo"
                        class="w-[48px] lg:w-[64px] inline-block dark:hidden" />
                    <img src="{{ url('/img/personal-logo-white.svg') }}" alt="logo"
                        class="w-[48px] lg:w-[64px] hidden dark:inline-block" />
                    <span class="text-xl xl:text-2xl font-bold text-[#0c7187] dark:text-white">Mehmet&nbsp;Ozdemir</span>
                </a>
            </div>
            <div class="flex px-4 justify-end items-center w-full">
                <div>
                    ...
                    <nav :class="!navbarOpen && 'hidden'" id="navbarCollapse"
                        class="absolute right-0 top-full bg-white py-5 px-6 z-50 shadow rounded-lg w-full dark:bg-slate-900 dark:text-slate-300 lg:px-0 lg:max-w-full lg:w-full lg:right-4 lg:block lg:static lg:shadow-none">
