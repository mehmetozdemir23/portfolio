...
<section id="contact" class="relative z-10 overflow-hidden bg-white py-20 lg:py-[120px] dark:bg-slate-900">
    <div class="container mx-auto">
      <div class="-mx-4 flex flex-wrap lg:justify-between">
        ...
        <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
          <div class="relative rounded-lg bg-white dark:bg-opacity-0 p-8 shadow-lg sm:p-12">
            <form>
              <div class="mb-6">
                <input
                  type="text"
                  placeholder="Your Name"
                  class="text-body-color border-[f0f0f0] focus:border-primary w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none dark:placeholder-slate-600 dark:bg-slate-200"
                />
              </div>
              <div class="mb-6">
                <input
              ...
              <div class="mb-6">
                <textarea
                  ...
                  class="text-body-color border-[f0f0f0] focus:border-primary w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none dark:placeholder-slate-600 dark:bg-slate-200"
                ></textarea>
              </div>
              <div>
                <button
