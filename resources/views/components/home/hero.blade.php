            ...
            <div class="w-full lg:w-5/12 px-4">
                <div class="hero-content">
                    ...
                    <p class="text-base mb-8 max-w-[520px] dark:text-slate-200">
                        <span>>&nbsp;</span>I am a junior full stack web developer specializing in Laravel and Vue.js<span class="text-3xl">.</span><br />
                    </p>
                    ...
                    <div class="clients pt-16">
                        <h6 class="font-normal text-md flex items-center text-body-color dark:text-slate-300 mb-4">
